...
<head><meta charset="gb18030">
    ...
    <title>Gestión de guarniciones</title>
...
<body>
    ...
    <br>
    <br>
        <h3 class="title">Gestión de guarniciones</h3>
        <br>
     <div class="col text-center">
        ...
        <p><?php echo $sql;?></p>
        <?php }else{?>
            <a href="crearguarnicion.php" class="btn btn-default btn btn-info btn-lg">Introducir guarnición</a>
        <?php }?> 
    </div>
    <br>
    ...
    <?php 
        ...
        <table class='table table-hover'>
                    ...
                    $sql = "SELECT * FROM guarnicones ORDER BY ingrediente ASC";
                    ...
                    if($result-> num_rows > 0) {
                        while($row = mysqli_fetch_assoc($result)){
                         echo "  
                         <tr>
                            <td class='producto'>".$row["ingrediente"]."</td>
                            <td>".$row["valor"]."</td>
                            <td><a href='#'><i class='fas fa-trash-alt'></i></a></td>
                            <td><a href='crearguarnicion.php?edit=".$row["id_guarnicion"]."'><i class='fas fa-edit'></i></a></td>
                        </tr>";
